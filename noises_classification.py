...
def decision_trees_classifier(X, y, cv):
	...
	print('Decision trees: ', accuracy_score(y_test, tree_pred)) # 0.693181818182
	...
	print('Decision trees, GridSearchCV-params: ', tree_grid.best_params_) # {'max_depth': 8}
	print('Decision trees, GridSearchCV-score: ', tree_grid.best_score_) # 0.655172413793
...
def knn_classifier(X, y, cv):
	...
	print('kNN, GridSearchCV-params: ', knn_grid.best_params_)
	print('kNN, GridSearchCV-score: ', knn_grid.best_score_)
...
def RFClassifier(X, y, cv):
    ...
    print('RandomForest, GridSearchCV-params: ', forest_grid.best_params_)
    print('RandomForest, GridSearchCV-score: ', forest_grid.best_score_)
